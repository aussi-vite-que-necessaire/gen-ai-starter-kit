...
- **API** : Auth (Better-Auth), DB (Drizzle), Producer (BullMQ).
- **Worker** : Consomme les jobs et trigger les webhooks n8n.
- **n8n** : Toute la logique métier. **Ne touche jamais la DB directement**.
